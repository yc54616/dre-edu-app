...
materialSchema.index({ isActive: 1, targetAudience: 1, createdAt: -1 });
materialSchema.index({ isActive: 1, targetAudience: 1, fileType: 1, createdAt: -1 });
materialSchema.index({ isActive: 1, targetAudience: 1, downloadCount: -1, createdAt: -1 });
materialSchema.index({ isActive: 1, targetAudience: 1, difficulty: 1, createdAt: -1 });
