      ...
      <div className="prose prose-blue max-w-none text-gray-700 space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-2">
            ...
            <li>
              광고성 정보 발송(마케팅 수신 동의 시): 연락처(전화번호), 이름, 마케팅 수신 동의 여부 및 일시
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>이벤트, 특강, 할인 등 광고성 정보 안내 (마케팅 수신 동의 회원에 한함)</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-2">
            ...
            <li>
              카카오 알림톡/브랜드 메시지 발송: 솔라피(Solapi) (상담 접수 확인·일정 안내 알림톡 및 브랜드 메시지(광고) 발송,
