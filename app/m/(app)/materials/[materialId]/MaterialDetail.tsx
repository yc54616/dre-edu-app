      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6 sm:px-8 py-6 sm:py-8">
          ...
          <div className="flex items-start gap-3 flex-wrap mb-4">
            ...
            {material.isFree && (
              <span className="text-[12px] font-black text-white bg-emerald-500 px-3.5 py-1.5 rounded-full">FREE</span>
            )}
          </div>

          <h1 className="text-3xl sm:text-[2.5rem] font-black text-gray-900 leading-tight tracking-tight mb-4">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid lg:grid-cols-5 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-3 space-y-5">
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden p-2">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <p className="text-[11px] font-black text-blue-600 uppercase tracking-widest mb-5 flex items-center gap-2">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 relative overflow-hidden">
              ...
              {material.isFree ? (
                ...
                <div className="space-y-3">
                  ...
                  {material.problemFile && (
                    <button
                      ...
                      className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl transition-all shadow-lg shadow-blue-500/20 hover:shadow-xl hover:-translate-y-0.5 flex items-center justify-center gap-2 disabled:opacity-60 disabled:translate-y-0 disabled:cursor-not-allowed"
                    >
                      {downloading === 'problem'
                ...
                <>
                    ...
                    <div className="space-y-3 mb-5 relative z-10">
                      ...
                      {selectedAmount > 0 && (
                        <div className="flex justify-between items-center pt-5 pb-2 border-t border-gray-100 mt-2">
                          ...
                          <span className="font-black text-blue-600 text-[1.75rem] tracking-tight">
                  ...
                  <Link
                    href={purchaseUrl}
                    className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold text-[16px] rounded-2xl transition-all shadow-lg shadow-blue-500/20 hover:shadow-xl hover:-translate-y-0.5 flex items-center justify-center gap-2.5 relative z-10"
                  >
                  ...
                  <div className="flex items-center justify-center gap-3 mt-4 text-xs text-gray-400 font-medium flex-wrap">
                    ...
                    <span className="flex items-center gap-1"><FileDown size={11} className="text-blue-600" />즉시 다운로드</span>
                    <span className="text-gray-200">·</span>
            ...
            {isLoggedIn && (material.isFree || purchasedFileTypes.length > 0) && (
              <div className="bg-white rounded-2xl border border-gray-100 p-6">
                <p className="text-[17px] font-black text-gray-900 mb-1">학습 후 난이도 평가</p>
        ...
        {relatedMaterials.length > 0 && (
          <div className="mt-12">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h2 className="text-lg font-black text-gray-900">함께 많이 찾는 자료</h2>
                ...
                return (
                  ...
                  >
                    <div className="aspect-[4/3] overflow-hidden relative">
                      ...
                      {r.isFree && (
                        <span className="absolute top-3 left-3 text-[10px] font-black bg-emerald-500 text-white px-2 py-1 rounded-full">FREE</span>
                      )}
                    </div>
                    <div className="p-4">
                      ...
                      <p className="text-[14px] font-bold text-gray-900 truncate leading-snug group-hover:text-blue-600 transition-colors">{rTitle || r.subject}</p>
