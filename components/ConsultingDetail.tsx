...
export default function ConsultingDetail() {
    const [form, setForm] = useState({ name: '', phone: '', schoolGrade: '', currentScore: '', targetUniv: '', direction: '', message: '' });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setResult('success');
            setForm({ name: '', phone: '', schoolGrade: '', currentScore: '', targetUniv: '', direction: '', message: '' });
        } catch {
            setResult('error');
        } finally {
            setSubmitting(false);
